...
def get_args():
    ...
    parser.add_argument("--input", type=str, default="data/qianyu.jpg", help="Path to input image")
    parser.add_argument("--output", type=str, default="data/qianyu_output.jpg", help="Path to output text file")
